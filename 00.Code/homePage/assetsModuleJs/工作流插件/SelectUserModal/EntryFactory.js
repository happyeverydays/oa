...
var textInputField = require('./TextInputEntryFactory'),
    ...
    multipleBox = require('./MultipleSelectEntryFactory'),
    dateFiled = require('./DateEntryFactory'),
    tabField=require('./TabSelectFactory'),
...
EntryFactory.multipleBox = function(options) {
  return multipleBox(options, setDefaultParameters(options));
};

EntryFactory.dateFiled = function(options) {
  return dateFiled(options, setDefaultParameters(options));
};
EntryFactory.tabField=function(options){
  return tabField(options, setDefaultParameters(options));
};
