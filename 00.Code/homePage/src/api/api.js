...
//获取流程用户接口
const getProcessAssignees=(params)=>getAction("http://36.152.9.51:8880//smart-boot/workflow/processUser/getProcessAssignees",params);

//获取流程候选人接口
const getProcessCandidates=(params)=>getAction("http://36.152.9.51:8880//smart-boot/workflow/processUser/getProcessCandidates",params);

//会签用户接口
const getCollections=(params)=>getAction("http://36.152.9.51:8880/smart-boot/workflow/processUser/getCollections",params);

 //04.会签权重接口
const getCompletionConditions=(params)=>getAction("http://36.152.9.51:8880/smart-boot/workflow/processUser/getCompletionConditions",params);
