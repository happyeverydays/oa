  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/problem/problemCategory/add",
          edit: "/problem/problemCategory/edit",
        },
        expandedRowKeys:[],
        pidField:"parentId"
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','companyId','level','parentId','hasChild','remark'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','companyId','level','parentId','hasChild','remark'))
      },
