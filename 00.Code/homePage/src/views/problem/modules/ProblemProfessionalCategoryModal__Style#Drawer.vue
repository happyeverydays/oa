    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="父节点编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'parentId', validatorRules.parentId]" placeholder="请输入父节点编号"></a-input>
        </a-form-item>
        <a-form-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'name', validatorRules.name]" placeholder="请输入名称"></a-input>
        </a-form-item>
        <a-form-item label="展示顺序" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="[ 'seq', validatorRules.seq]" placeholder="请输入展示顺序" style="width: 100%"/>
        </a-form-item>
...
<script>
  ...
  export default {
    name: "ProblemProfessionalCategoryModal",
    components: { 
      JDate,
    },
    data () {
      return {
        ...
        validatorRules:{
        companyId:{rules: [{ required: true, message: '请输入公司编号!' }]},
        parentId:{},
        ...
        url: {
          add: "/problem/problemProfessionalCategory/add",
          edit: "/problem/problemProfessionalCategory/edit",
        }
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'companyId','parentId','name','seq','createTime','createBy','updateTime','updateBy'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'companyId','parentId','name','seq','createTime','createBy','updateTime','updateBy'))
      }
