<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <RiskItem-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/risk/riskUnit/listRiskItemByMainId",
          delete: "/risk/riskUnit/deleteRiskItem",
          deleteBatch: "/risk/riskUnit/deleteBatchRiskItem",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加管控措施条目";
      },
    }
  }
</script>
