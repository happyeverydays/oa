    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="风险类型"
          hasFeedback>
          <a-input placeholder="请输入风险类型" v-decorator="['risktype', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: '/risk/riskUnit/addRiskMeasures',
          edit: '/risk/riskUnit/editRiskMeasures'
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      edit(record, v) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'seq', 'companyid', 'riskunitid', 'risktype', 'content', ))
          // 时间格式化
        })
      },
      close() {
