    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="打卡开始时间">
              <a-input placeholder="请输入打卡开始时间" v-model="queryParam.start_time"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="打卡结束时间">
              <a-input placeholder="请输入打卡结束时间" v-model="queryParam.end_time"></a-input>
            </a-form-item>
          </a-col>
...
<script>
import AttendRecordModal from './modules/AttendRecordModal'
...
export default {
      ...
      columns: [
        ...
        },
        {
          ...
          customRender: (text, record, index) => {
            return filterDictText(this.deviceOptions, text)
          }
        },
        // {
        //   title: '打卡班次',
        ...
        // },
        {
          ...
          dataIndex: 'attendWay',
          customRender: (text, record, index) => {
            return filterDictText(this.atend_wayOptions, text)
          }
        },
        {
          title: '地点',
  ...
  methods: {
    initDictConfig() {
      initDictOptions('atend_type').then(res => {
        if (res.success) {
          this.atend_wayOptions = res.result
        }
      })
