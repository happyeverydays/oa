...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/monitorAlarm/list',
        delete: '/monitorAlarm/delete',
        deleteBatch: '/monitorAlarm/deleteBatch',
        exportXlsUrl: 'monitorAlarm/exportXls',
        importExcelUrl: 'monitorAlarm/importExcel'
      }
    }
  },
  computed: {
