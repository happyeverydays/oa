package com.huizhixin.smart.modules.message.job;
...
import com.huizhixin.smart.modules.message.entity.SysMessage;
import com.huizhixin.smart.modules.message.handle.ISendMsgHandle;
import com.huizhixin.smart.modules.message.handle.enums.SendMsgStatusEnum;
import com.huizhixin.smart.modules.message.handle.enums.SendMsgTypeEnum;
import com.huizhixin.smart.modules.message.service.ISysMessageService;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" Smart-Boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
