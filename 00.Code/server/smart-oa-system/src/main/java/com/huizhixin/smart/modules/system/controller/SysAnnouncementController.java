...
import com.huizhixin.smart.common.constant.CommonSendStatus;
...
import com.huizhixin.smart.modules.system.service.ISysAnnouncementService;
...
//	@Resource
	...
	public Result<Map<String,Object>> listByUser() {
		...
		try {
			...
			Map<String, Object> sysMsgMap = new HashMap<String, Object>();
			sysMsgMap.put("sysMsgList", new ArrayList<>());
			sysMsgMap.put("sysMsgTotal", 0);
			sysMsgMap.put("anntMsgList",  new ArrayList<>());
			sysMsgMap.put("anntMsgTotal",0);
			result.setResult(sysMsgMap);
		}
		result.setSuccess(true);
