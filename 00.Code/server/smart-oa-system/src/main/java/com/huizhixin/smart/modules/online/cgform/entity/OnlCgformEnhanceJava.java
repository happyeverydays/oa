...
public class OnlCgformEnhanceJava implements Serializable {
	...
	public String toString() {
		return "OnlCgformEnhanceJava(id=" + this.getId() + ", cgformHeadId=" + this.getCgformHeadId() + ", buttonCode="
				+ this.getButtonCode() + ", cgJavaType=" + this.getCgJavaType() + ", cgJavaValue="
				+ this.getCgJavaValue() + ", activeStatus=" + this.getActiveStatus() + ", event=" + this.getEvent()
				+ ")";
	}
}