...
public class OnlCgformEnhanceSql implements Serializable {
	...
	public String toString() {
		return "OnlCgformEnhanceSql(id=" + this.getId() + ", cgformHeadId=" + this.getCgformHeadId() + ", buttonCode="
				+ this.getButtonCode() + ", cgbSql=" + this.getCgbSql() + ", cgbSqlName=" + this.getCgbSqlName()
